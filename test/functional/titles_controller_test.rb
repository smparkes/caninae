...
class TitlesControllerTest < ActionController::TestCase
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post :create, title: { abbreviation: @title.abbreviation, name: @title.name, prefix: @title.prefix, registry_id: @title.registry_id }
    end
  ...
  test "should update title" do
    put :update, id: @title, title: { abbreviation: @title.abbreviation, name: @title.name, prefix: @title.prefix, registry_id: @title.registry_id }
    assert_redirected_to title_path(assigns(:title))
  end
